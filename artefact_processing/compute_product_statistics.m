...
fileID = fopen('artefact_processing\artefact_statistics\artefact_free_data_product_statistics.txt', 'w+');
counter = 0;
...
disp('artefact_free_data_product_statistics.txt has been computed')
