...
% feature 1 files
writematrix(P_d_arr, 'features\Avg_pw_d.csv');
writematrix(P_t_arr, 'features\Avg_pw_t.csv');
writematrix(P_a_arr, 'features\Avg_pw_a.csv');
writematrix(P_b_arr, 'features\Avg_pw_b.csv');
writematrix(P_g_arr, 'features\Avg_pw_g.csv');

% feature 2 files
writematrix(tP_d_arr, 'features\Spec_Energy_d.csv');
writematrix(tP_t_arr, 'features\Spec_Energy_t.csv');
writematrix(tP_a_arr, 'features\Spec_Energy_a.csv');
writematrix(tP_b_arr, 'features\Spec_Energy_b.csv');
writematrix(tP_g_arr, 'features\Spec_Energy_g.csv');

% feature 3 files
writematrix(pA_arr, 'features\peak_alpha.csv');

% feature 4 files
writematrix(hem_pw_arr, 'features\hemis_asymmetry.csv');
