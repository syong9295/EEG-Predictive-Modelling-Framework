...
fileID = fopen('artifact_processing\artifact_statistics\artifact_free_data_subject_statistics.txt', 'w+');
counter = 1;
...
disp('artifact_free_data_subject_statistics.txt has been computed')
