...
function [] = compute_product_statistics()
...
for i = 1 : data_no  % for each txt file
    ...
    no_prod = temp(end-5:end-4);  % get the product number with or without underscore (_1, _2 ... 41)
...
fileID = fopen('artifact_processing\artifact_statistics\artifact_free_data_product_statistics.txt', 'w+');
counter = 0;
...
disp('artifact_free_data_product_statistics.txt has been computed')
